			...
			<div class="boxed-widget margin-top-30 margin-bottom-50">
				...
				<div class="main-btn-new">
					<a href="#small-dialog" class="send-message-to-owner button popup-with-zoom-anim new-btn-class">
						...
						<?php
						if (in_array("guest", $user_info->roles)) esc_html_e('Message', 'listeo');
						else esc_html_e('Message', 'listeo');
						/*if(in_array("administrator", $user_info->roles))esc_html_e('Message', 'listeo');
							else if(in_array("owner", $user_info->roles))esc_html_e('Message', 'listeo');
							else if(in_array("editor", $user_info->roles))esc_html_e('Message', 'listeo');
							else esc_html_e('Message', 'listeo'); */
