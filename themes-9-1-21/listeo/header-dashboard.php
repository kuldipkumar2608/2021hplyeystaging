				...
				<div id="logo">
					<?php 
		                ...
		                $logo_dashboard = get_option( 'pp_dashboard_logo_upload', '' ); 
		             	if($logo) { ?>
		                    <a href="<?php echo esc_url( 'www.hypley.com' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
		                    	<img src="<?php echo esc_url($logo); ?>" data-rjs="<?php echo esc_url($logo_retina); ?>" 
		                    	alt="<?php esc_attr(bloginfo('name')); ?>"/>
		                    </a>
		                    <a href="<?php echo esc_url( 'www.hypley.com' ); ?>" class="dashboard-logo" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
							...
							<h1>
								<a href="<?php echo esc_url( 'www.hypley.com' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a>
							</h1>
		                    <?php 
		                }
	                ?>
